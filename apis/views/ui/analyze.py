import json, os, numpy, tensorflow
from sklearn import metrics
from rest_framework.views import APIView
from rest_framework.response import Response

from apis.models import CustomUser, Scenario, ScenarioSolution
from apis.views.helpers_views import BASE_DIR, save_files_return_paths
from apis.views.ui.dashboard import unsupervised_FinalScore
        ...
        if request.data is not None:
            ...
            def get_performance_metrics(model, test_data, target_column, train_data, factsheet):
                ...
                if (isinstance(model, tensorflow.keras.Sequential)):
                    ...
                    labels = numpy.unique(numpy.array([y_pred, y_true]).flatten())
            ...
            def detect_outliers_range(mdoel, df, threshold_mse):
                ...
                outliers = [(numpy.array(mse) < up_bound) &
                            (numpy.array(mse) > bottom_bound)]
                return outliers
